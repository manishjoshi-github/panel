<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @endcan
            @can('phycometric_exam_access')
                <li class="{{ request()->is('admin/phycometric-exams') || request()->is('admin/phycometric-exams/*') ? 'active' : '' }}">
                    <a href="{{ route("admin.phycometric-exams.index") }}">
                        <i class="fa-fw fas fa-cogs">

                        </i>
                        <span>{{ trans('cruds.phycometricExam.title') }}</span>
                    </a>
                </li>
            @endcan
            <li>
